...
[![GitHub release](https://img.shields.io/github/release/marswaveai/colamd.svg)](https://github.com/40740/mdapp-elegant/releases)
...
- **Themes** — Five built-in themes (incl. the exclusive Elegant Plus), downloadable themes, and custom CSS imports.
...
> Check [Releases](https://github.com/40740/mdapp-elegant/releases) for the latest builds.
...
```bash
git clone https://github.com/40740/mdapp-elegant.git
cd colamd
npm install
npm run dev
```

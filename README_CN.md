...
- **主题** — 5 个内置主题（含专属「优雅 Plus」）、可下载主题，以及自定义 CSS 导入。
...
> 查看 [Releases](https://github.com/40740/mdapp-elegant/releases) 获取最新构建。

### macOS ARM (Apple Silicon)

安装包为**未签名**构建，首次打开若提示“已损坏”，请在终端执行：

```bash
xattr -dr com.apple.quarantine /Applications/ColaMD.app
```
